...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/webmd-health-services/Carbon.Environment'
            ...
            ReleaseNotes = 'https://github.com/webmd-health-services/Carbon.Environment/blob/main/CHANGELOG.md'
