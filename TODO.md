...
* Rename every file that has `Carbon.Environment` in its name, replacing `Carbon.Environment` with the module name.
* Replaces `Carbon.Environment` in every file with the module name.
